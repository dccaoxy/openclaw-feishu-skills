...
URL Source: http://lobehub.com/skills/openclaw-skills-feishu-sheets-skill/skill.md

Published Time: Mon, 23 Mar 2026 00:51:47 GMT
...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `openclaw-skills-feishu-sheets-skill`                                |
| Version    | 1.0.2                                     |
| Author     | openclaw                                 |
...
Feishu Sheets Tool provides programmatic control over Feishu online spreadsheets for automation, reporting, and integration tasks. It supports creating spreadsheets (optionally in a specific folder), extracting spreadsheet and sheet IDs from URLs, and returning spreadsheet_token, url, and title. Core operations include reading and writing cell ranges, appending rows, inserting or deleting rows/columns (dimension operations), and adding or deleting worksheets. The tool accepts standard A1-style ranges, entire rows/columns, and sheet-scoped ranges (sheet_id!A1:C10). A get_info action returns metadata including all sheet_ids and titles. Use this Skill when automating data entry, synchronizing data between systems, building reports, or managing workbook structure programmatically in Feishu Sheets. Key advantages are concise action-based calls, full sheet lifecycle control, and clear ID/range semantics for reliable automation.
...
```bash
npx -y @lobehub/market-cli skills install openclaw-skills-feishu-sheets-skill
```
...
npx -y @lobehub/market-cli skills install openclaw-skills-feishu-sheets-skill --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install openclaw-skills-feishu-sheets-skill --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install openclaw-skills-feishu-sheets-skill --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install openclaw-skills-feishu-sheets-skill --version 1.0.2
```
...
```bash
npx -y @lobehub/market-cli skills rate openclaw-skills-feishu-sheets-skill --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment openclaw-skills-feishu-sheets-skill -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment openclaw-skills-feishu-sheets-skill
```
...
```bash
npx -y @lobehub/market-cli skills comments openclaw-skills-feishu-sheets-skill
```
